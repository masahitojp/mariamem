...
from release_version import CORRESPONDING_SOURCE, GIT_TAG, PYTHON_VERSION, SOURCE_CANDIDATE
...
def check_candidate(commit, acceptance_path):
    ...
    notices = verify_runtime_notices()
    ...
    expected_native = payload(ROOT, build / "guest-aot")
...
def main():
    ...
    try:
        result = check_candidate(args.candidate_sha, args.native_acceptance)
        ...
        return 1
    output = ROOT / "build/release/ci-ready.json"
